...
from Redox import Nihal
from Redox.modules.no_sql import NihalXdb as db
from Redox.utils.pluginhelp import member_permissions
...
@Nihal.on_message(filters.command("unpinall") & ~filters.private)
...
@Nihal.on_message(filters.command("antichannelpin") & ~filters.private)
...
@Nihal.on_message(filters.command("cleanlinked") & ~filters.private)
...
@Nihal.on_message(filters.command("permapin") & ~filters.private)
...
@Nihal.on_message(filters.linked_channel)
