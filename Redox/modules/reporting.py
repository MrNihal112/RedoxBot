...
from Redox import DRAGONS, LOGGER, TIGERS, WOLVES
...
from Redox.modules.sql import reporting_sql as sql
...
@Redoxcmd(command="report", filters=Filters.chat_type.groups, group=REPORT_GROUP)
@Redoxmsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
...
@Redoxcallback(pattern=r"report_")
