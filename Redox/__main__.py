...
import Redox.modules.no_sql.users_db as sql
from Redox import BOT_USERNAME, CERT_PATH
from Redox import LOGGER as log
from Redox import OWNER_ID, OWNER_USERNAME, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK
from Redox import Nihal as pbot
from Redox import StartTime, dispatcher, telethn, updater

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from Redox.modules import ALL_MODULES
from Redox.modules.helper_funcs.chat_status import is_user_admin
from Redox.modules.helper_funcs.decorators import Redoxcallback, Redoxcmd, Redoxmsg
from Redox.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(text=f"☁️ sᴏᴜʀᴄᴇ ☁️", CallbackQuery.edit_message_media(media=InputMediaVideo("https://telegra.ph/file/9b0455dae14d5639f936d.mp4", caption="etc")),
        InlineKeyboardButton(text=f"🥀 ᴅᴇᴠᴇʟᴏᴩᴇʀ 🥀", url=f"tg://user?id={OWNER_ID}"),
    ],
]
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Redox.modules." + module_name)
...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='sᴜᴘᴘᴏʀᴛ', url='https://t.me/FeelingsXDChat'),
...
@Redoxcallback(pattern=r"start_back")
@Redoxcmd(command="start", pass_args=True)
...
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/Redox'),
...
@Redoxcallback(pattern=r"stngs_")
...
@Redoxmsg(Filters.status_update.migrate)
...
if __name__ == "__main__":
    log.info("[ʀᴇᴅᴏx] →  sᴜᴄᴄᴇssғᴜʟʟʏ ʟᴏᴀᴅᴇᴅ ᴍᴏᴅᴜʟᴇs: " + str(ALL_MODULES))
