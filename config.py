...
class Config(object):
    ...
    OWNER_ID = int(getenv("OWNER_ID", "5938660179"))  # sᴛᴀʀᴛ @Redox_Robot ᴛʏᴘᴇ /id
    OWNER_USERNAME = getenv("OWNER_USERNAME", "Mr_Nihal9")
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "FeelingsXDChat")
